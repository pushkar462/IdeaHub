...
-- CreateEnum
CREATE TYPE "PostCategory" AS ENUM ('BUG', 'IMPROVEMENT', 'SUGGESTION', 'FEATURE', 'IDEA', 'DISCUSSION', 'PROBLEM');

-- CreateEnum
CREATE TYPE "WorkflowStatus" AS ENUM ('BACKLOG', 'TODO', 'IN_PROGRESS', 'IN_REVIEW', 'BLOCKED', 'DONE');
...
-- CreateEnum
CREATE TYPE "AuditActionType" AS ENUM ('POST_CREATED', 'POST_UPDATED', 'STATUS_CHANGED', 'ASSIGNED', 'UNASSIGNED', 'DEPARTMENT_CHANGED', 'COMMENT_CREATED', 'COMMENT_DELETED', 'ATTACHMENT_UPLOADED');
...
-- CreateIndex
CREATE INDEX "Post_priority_idx" ON "Post"("priority");
